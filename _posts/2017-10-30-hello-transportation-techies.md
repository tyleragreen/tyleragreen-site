...
Michael always puts on an incredible event and Metro Hack Night VII was no exception! We had a great [line-up](http://mvjantzen.com/meetup/metrohacknight7.html) and [turnout](https://www.flickr.com/photos/mvjantzen/37248206144/). I presented on how we can use graph theory to study transit networks, specifically WMATA Metrorail with and without the Purple line.

All the presenters blew me away with their excellent, excellent projects. The DC transit developer community is special and I loved getting to experience it for one night. You can read about the all projects and presenters in this [write-up from Mobility Lab](https://mobilitylab.org/2017/10/27/techies-better-ways-figure-catch-metro-train/).
...
<div style="text-align:center">
  <a href="/assets/pdf/gtfs-graph_TylerGreen.pdf">
    <img src="/assets/img/2017-10-30/graphed_cover.png" />
  </a>
</div>

You can [download the PDF deck](/assets/pdf/gtfs-graph_TylerGreen.pdf) of my presentation.
